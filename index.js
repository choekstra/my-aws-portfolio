document.addEventListener('DOMContentLoaded', function() {
  fetch('https://knbqxc7xrmrdomzo7rwpwz7f440pgtyh.lambda-url.us-east-1.on.aws') //Fetch LAMBDA FUNCTION URL - make sure to not add a trailing slash
  ...
  document.getElementById('generateDescription').addEventListener('click', function() {
    ...
    console.log('xGenerating AI description for image ID:', imageId);
    // Show spinner
  ...
  function generateAiDescription(imageId) {
    console.log('In generateAiDescription', imageId);
    const aiDescriptionEndpoint = 'https://3tujudwdiau5clqofmn5abgxoe0nvkpy.lambda-url.us-east-1.on.aws'; // GENERATE AI LAMBDA FUNCTION URL - and 
    ...
    .then(data => {
      console.log('xAI description generated:', data.description);
